...
from accounts.forms import CustomUserForm, MyAuthenticationForm
from accounts.models import AuditEntry, User
from accounts.services import send_mail_to_user_reset_password
